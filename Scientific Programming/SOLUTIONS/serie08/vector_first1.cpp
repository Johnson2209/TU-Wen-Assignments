...
//Attention: g++ requires explicit type casting
//for pointers, e.g., malloc (line 12)
//In C++ variables can be declared everywhere
//In C (original standard) only at the beginning of a
//block, which leads to more readable code
//Declaration right before use for local counter
//variables is acceptable (line 14)
